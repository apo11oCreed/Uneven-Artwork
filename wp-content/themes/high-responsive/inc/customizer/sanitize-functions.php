<?php
/**
 * High Responsive Theme Options Sanitization Functions
 *
 ...
 */
function highresponsive_sanitize_select( $input, $setting ) {
 ...
 */
function highresponsive_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function highresponsive_sanitize_post( $input ) {
 ...
 */
function highresponsive_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function highresponsive_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function highresponsive_sanitize_number_range( $number, $setting ) {
